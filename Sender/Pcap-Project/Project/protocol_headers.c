...
/*protocol info*/
unsigned char src_mac_ethernet[] = { 0x2c, 0x4d, 0x54, 0xd0, 0xef, 0xd7 };	// Ethernet Bane (sender)
unsigned char src_mac_wifi[] = { 0x00, 0x0f, 0x60, 0x06, 0x1f, 0x50 };		// Wifi Bane (sender)

unsigned char dst_mac_ethernet[] = { 0x2c, 0x4d, 0x54, 0x56, 0x99, 0x17 };	// Ethernet Stevan (receiver)
unsigned char dst_mac_wifi[] = { 0x00, 0x0f, 0x60, 0x08, 0x1e, 0x5e };		// Wifi Stevan (receiver)


unsigned char next_protocol_header_ipv4[2] = { 0x08, 0x00 };
unsigned int next_protocol_header_udp = 17;

unsigned char dst_ip_ethernet[] = { 192, 168, 212, 1 };						// Ethernet Stevan (receiver)
unsigned char src_ip_ethernet[] = { 192, 168, 106, 1 };						// Ethernet Bane (sender)

unsigned char dst_ip_wifi[] = { 192, 168, 123, 1 };							// Wifi Stevan (receiver)
unsigned char src_ip_wifi[] = { 192, 168, 123, 18 };						// Wifi Bane (sender)
